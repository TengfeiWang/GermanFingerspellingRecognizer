...
public class ContRecogPanelEntropy extends javax.swing.JPanel {
	...
	private  ContTimerManagerEntropy task;
	...
	*/
	...
	public ContRecogPanelEntropy ( List<Integer> allFeaturs, String workDir,List<Integer> featureVectorUsed) {
		super();
	...
	private void startButtonActionPerformed(ActionEvent evt) {
		new Thread(new Runnable() {
            ...
            public void run() {
            	...
            	task = new ContTimerManagerEntropy(controller,OS,allFeaturs,recordedSeqs);
    		task.start();
